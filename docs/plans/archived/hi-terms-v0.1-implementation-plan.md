> **归档说明（2026-04-06）：** 本文档已归档。Phase A-B 已完成，Phase C-F 的执行状态追踪已迁移至 [Next2Do/v0.1-execution.md](../../../Next2Do/v0.1-execution.md)。本文档中的任务定义（C1, C2, D1-D4, E1-E4, F1-F6）仍作为任务详细描述的权威来源，由 Next2Do 通过任务 ID 引用。
